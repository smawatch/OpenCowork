...
export const useSettingsStore = create<SettingsStore>()(
  persist(
    (set) => ({
      ...
      embeddingApiKey: 'sk-ws-H.RXHPLPH.c3ew.MEUCIQD1K6lOYD_ChOs21FyrXohsPf88gfsv6Q6Zpjf6XipAWQIgRG1hMto8MGxQtbO6M5DED0eghKhbFqIBGoMc9RsrGZ0',
      rerankModel: 'qwen3-rerank',
      rerankBaseUrl: 'https://dashscope.aliyuncs.com/compatible-api/v1/reranks',
      rerankApiKey: 'sk-ws-H.RXHPLPH.c3ew.MEUCIQD1K6lOYD_ChOs21FyrXohsPf88gfsv6Q6Zpjf6XipAWQIgRG1hMto8MGxQtbO6M5DED0eghKhbFqIBGoMc9RsrGZ0',
      cleanupModel: 'qwen-flash',
      cleanupBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions',
      cleanupApiKey: 'sk-ws-H.RXHPLPH.c3ew.MEUCIQD1K6lOYD_ChOs21FyrXohsPf88gfsv6Q6Zpjf6XipAWQIgRG1hMto8MGxQtbO6M5DED0eghKhbFqIBGoMc9RsrGZ0',
      maxTokens: 32000,
      temperature: 0.7,
      systemPrompt: '',
