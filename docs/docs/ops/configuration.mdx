...
| `~/.open-cowork/extensions.json`         | Extensions 启用状态与普通配置                                       |
| `~/.open-cowork/extensions-storage.json` | Extensions sandbox storage                                          |
| `~/.open-cowork/extensions/`             | 已安装 extension manifest、JS entry 和 HTML renderer                |
